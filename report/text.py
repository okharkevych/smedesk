class Text:
    ...
    ANY_OTHER_ANSWER_COMBINATION: str = (
    ...
    YES_AND_EMAILS_AND_LIVE_CHATS: str = (
    ...
    YES_AND_OTHER_ANSWER_COMBINATIONS: str = (
    ...
    def time_more_than_240_minutes(time_period, unit_of_time):
        return (
            ...
            f"{unit_of_time} Vivamus hendrerit arcu eros, "
            ...
            f"{round(time_period * 1.5, 1)} {unit_of_time} imperdiet lectus at"
            f" imperdiet ornare."
        )
    ...
    def time_less_than_120_minutes(time_period, unit_of_time):
        return (
            ...
            f"duration: {round(time_period * 1.5 * 3.5, 1)} {unit_of_time} "
            f"Integer viverra porta eros nec ultrices. Nullam ante sem, "
            f"tincidunt vitae orci id, vestibulum auctor risus. Phasellus sit "
            f"amet lobortis eros. Maecenas convallis dolor ex, vel congue "
            f"ipsum ornare eu.\n\nNunc in mattis dolor, quis posuere lorem. "
            f"Recommended shift duration: {round(time_period * 1.5 * 3.5, 1)}"
            f" {unit_of_time} Nullam condimentum semper "
    ...
    def other_time_frames(time_period, unit_of_time):
        return (
            ...
            f"{round(time_period * 1.5 * 2.67, 1)} {unit_of_time} Suspendisse "
            f"tellus magna, faucibus scelerisque dapibus et, luctus egestas "
            f"nibh. Pellentesque eleifend mauris ac volutpat ullamcorper.\n\n"
            f"Aenean vitae velit et nulla egestas viverra sit amet eu "
            f"eros. Recommended shift duration: "
            f"{round(time_period * 1.5 * 2.67, 1)} {unit_of_time} Nunc congue "
            f"rutrum sem"
        )
